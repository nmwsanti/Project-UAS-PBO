...
public class pbokalkulator extends javax.swing.JDialog {
    private String tmp = "";
    private int pilih;
    private float a1,a2,hasil;
    
    public pbokalkulator(java.awt.Frame parent, boolean modal) {
        super(parent, "PBO KALKULATOR");
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                pbokalkulator dialog = new pbokalkulator(new javax.swing.JFrame(), true);
